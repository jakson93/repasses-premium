...
export default function Header({ zIndex = "z-50" }: { zIndex?: string }) {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 ${zIndex} bg-black/95 backdrop-blur-lg border-b border-yellow-500/20`}>
